...
def print_confusion_matrix(model_name, y_test, predictions):
    ...
    plt.savefig('./results/RNA/'+model_name+'_Confusion_Matrix.png')
...
if __name__ == "__main__":
    ...
    plt.legend()
    # show the plot
    plt.savefig("./results/RNA/XGB_loss_curve.png")
    
    clf.save_model("./models/RNA/XGB_classifier.json")
    
    y_pred = clf.predict_proba(x_test)[:,1]
    
    print_metrics("XGB_rna", y_test, y_pred)
